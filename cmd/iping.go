...
type IPingCommand struct {
}

func init() {
	pingCmd := IPingCommand{}
	config.Parser.AddCommand("iping", "Pings the internal farming service[Free]", "", &pingCmd)
}

func (ec *IPingCommand) Execute(args []string) error {
	config.Conf(false)
