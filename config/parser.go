...
type architCommand struct {
	...
	PortBase       int    `short:"p" long:"PortBase" description:"Primary port number Archit servers will listen to. Port# +1 & +2 will be used interally for server communication" default:"1958" env:"ARCHIT_PORT"`
